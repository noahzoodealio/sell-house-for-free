...
export const claims: readonly AntiBrokerClaim[] = [
  {
    ...
    fulfillmentAnchor:
      "Marketing copy across home, four pillar pages, and city landers names exactly four revenue streams (buyer-broker MLS commission, cash-offer buyer-side spread, Cash+ ARV-uplift share, Renovation Hola Home Services commission), disclosed verbatim on /why-its-free via src/content/revenue/streams.ts. There is no seller-charge code path in the planned E5 submission flow; verification deferred to E5 architecture.",
