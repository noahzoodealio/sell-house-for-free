...
export const entries: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    category: "how-it-works",
    question: "What are Cash+ and Renovation?",
    answer:
      "Cash+: an investor partner funds pre-list repairs so your home sells for more on the MLS. The investor is repaid at close and takes an agreed share of the uplift. You never pay for the work out of pocket.\n\nRenovation: a full pre-list renovation you pay for from sale proceeds, not out of pocket. No investor split on this path, so every dollar above the renovation cost is yours. Best fit when you have time and want the maximum list price.",
  ...
  },
  {
    ...
    answer:
      "Cash offers: as fast as 7\u201314 days to close, depending on title work.\n\nStandard MLS listing: the AZ median is typically under 60 days on market from list to contract; add ~30 days for close. Cash+ adds the repair window up front but tends to sell faster once listed because the home shows better.",
    relatedPillar: "listing",
    lastReviewed: REVIEWED,
  },
  {
