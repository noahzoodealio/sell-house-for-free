...
Legacy cleanup: when --legacy-dir and --module-code are provided, deletes the old
per-module module-help.csv file at {legacy-dir}/{module-code}/. Only the current
module's own legacy staging is touched — {legacy-dir}/core/ and every other
module directory are left alone.
...
def cleanup_legacy_csvs(
    ...
    """Delete legacy per-module module-help.csv for this module only.
