...
anything. Directories without skills are removed directly.
...
def verify_skills_installed(
    ...
    that contain no skills are silently skipped.
...
def main():
    ...
    # Build the list of directories to remove. Only touch this module's own
    # legacy staging plus anything explicitly passed via --also-remove.
    # Never include "core" — that belongs to the BMad core module.
